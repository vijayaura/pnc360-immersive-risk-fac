...
const sidebarItems = [
  ...
  },
  {
    ...
    url: '/reinsurer/analytics',
    icon: BarChart3,
  },
];

export function ReinsurerLayout() {
        ...
        <Sidebar className="border-r border-sidebar-border shadow-xl">
          <SidebarHeader className="border-b p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-extrabold text-slate-200">Reinsurer Portal</h2>
                <p className="text-sm text-slate-400">P&C Platform</p>
              </div>
            </div>
          </SidebarHeader>
            ...
            <SidebarGroup>
              <div className="mb-6 p-3 bg-primary/5 rounded-lg border">
                <p className="text-sm font-semibold text-sidebar-foreground mb-1">
                  {user?.name || 'Demo Reinsurer'}
                </p>
                <p className="text-xs font-medium text-sidebar-foreground/80">Reinsurer</p>
              </div>
          ...
          <SidebarFooter className="border-t p-4">
            <div className="mb-3 rounded-lg bg-primary/5 border p-3">
              <p className="text-sm font-semibold text-sidebar-foreground">{user?.name || 'Demo Reinsurer'}</p>
              <p className="truncate text-xs font-medium text-sidebar-foreground/80">
                {user?.email || 'demo@reinsurer.local'}
              </p>
            </div>
            <Button
              variant="ghost"
          ...
          <header className="flex h-16 items-center border-b bg-primary/5 shadow-sm">
            <div className="flex w-full items-center gap-4 px-6">
              ...
              <div className="flex-1">
                <h1 className="text-xl font-bold text-foreground">Reinsurer Portal</h1>
                <p className="text-sm text-muted-foreground">Monitor ceded risk, treaty exposure, and policy participation</p>
              </div>
