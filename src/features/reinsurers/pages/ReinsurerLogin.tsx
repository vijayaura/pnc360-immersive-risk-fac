...
const DEMO_TOKEN = 'dummy-reinsurer-token';
const DEMO_REFRESH_TOKEN = 'dummy-reinsurer-refresh-token';

export default function ReinsurerLogin() {
  const navigate = useNavigate();
  const { setUser, setToken, setRefreshToken } = useAuthStore();
  const [showPassword, setShowPassword] = useState(false);
  const [formData, setFormData] = useState({
    email: 'reinsurer@demo.com',
    password: 'password',
  });
  ...
  const handleLogin = (event: FormEvent) => {
    ...
    const demoUser = {
      ...
      name: 'Demo Reinsurer',
      role: 'reinsurer' as const,
      userType: 'REINSURER',
      user_type: 'reinsurer',
      organizationId: 'demo-reinsurer-org',
    };
      ...
      <div className="flex min-h-screen w-full cityscape-bg">
        <div className="relative hidden w-1/2 overflow-hidden text-white lg:flex">
          ...
          <div className="relative z-10 mx-auto my-auto flex w-full max-w-xl flex-col rounded-2xl border border-white/10 bg-white/5 px-12 py-16 backdrop-blur-[2px]">
            ...
            <h1 className="mb-4 text-4xl font-bold leading-tight lg:text-5xl">Reinsurer Portal</h1>
            <p className="text-base leading-relaxed text-white/90 lg:text-lg">
              Review ceded exposures, treaty participation, and policy-level reinsurance insights in a secure demo workspace.
            </p>
          </div>
        </div>
          ...
          <div className="relative z-10 flex flex-1 items-center justify-center">
            <div className="w-full max-w-md">
              <div className="mb-8 text-center">
                ...
                <h1 className="mb-2 text-3xl font-bold text-foreground">Reinsurer Login</h1>
              ...
              <Card className="border-0 bg-white/95 shadow-2xl backdrop-blur-sm">
                <CardHeader className="space-y-1 pb-6 text-center">
                  ...
                  <CardDescription>Sign in to open the Reinsurer dashboard.</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="reinsurer@demo.com"
                      />
                    </div>
